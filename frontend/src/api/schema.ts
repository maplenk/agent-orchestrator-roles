...
export interface paths {
    ...
    "/api/v1/projects/{id}/role-map": {
        ...
        get?: never;
        /** Compare-and-swap a project's role map without replacing unrelated config */
        put: operations["setProjectRoleMap"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/v1/sessions/{sessionId}/output": {
        ...
        /** Read bounded terminal output for a TUI session */
...
export interface components {
    schemas: {
        ...
        UpdateProjectSettingsInput: {
            config: components["schemas"]["ProjectConfig"];
            displayName: string;
            expectedRoleMapSha256?: null | string;
        };
...
export interface operations {
    ...
    setProjectRoleMap: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SetProjectRoleMapInput"];
            };
        };
        responses: {
            /** @description OK */
    ...
    getSessionOutput: {
        parameters: {
            query?: {
                /** @description Number of trailing terminal lines to return (default 200, maximum 1000). */
                lines?: number;
            };
            header?: never;
            path: {
