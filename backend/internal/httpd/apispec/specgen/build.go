...
var schemaNames = map[string]string{
	...
	"DomainRoleResultReport":          "RoleResultReport",
	"DomainSessionRoleResult":         "SessionRoleResult",
	...
	"ControllersAgentSwitchTargetView":                    "AgentSwitchTarget",
	"ControllersAgentSwitchOptionsResponse":               "AgentSwitchOptionsResponse",
...
func sessionOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/agent-switches", id: "createSessionAgentSwitch", tag: "sessions",
		...
		},
		{
			...
			summary:    "Compatibility alias for creating a session agent switch",
			pathParams: []any{controllers.SessionIDParam{}},
			reqBody:    controllers.SwitchAgentRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.AgentSwitchResponse{}},
		...
		{
			method: http.MethodGet, path: "/api/v1/sessions/{sessionId}/agent-switch-options", id: "getSessionAgentSwitchOptions", tag: "sessions",
			summary:    "List exact daemon-authorized agent-switch targets for a worker",
			pathParams: []any{controllers.SessionIDParam{}},
			resps: []respUnit{
				{http.StatusOK, controllers.AgentSwitchOptionsResponse{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
			},
		},
		{
			...
			summary:    "Safely reconcile one exact interrupted agent switch",
