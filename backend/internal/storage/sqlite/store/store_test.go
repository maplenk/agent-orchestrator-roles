...
func TestSessionPersistsDeterministicHandoffInputs(t *testing.T) {
	...
	if got.Metadata.LatestUserPrompt != rec.Metadata.LatestUserPrompt || got.Metadata.LatestAssistantUpdate != rec.Metadata.LatestAssistantUpdate || got.Metadata.NativeTranscriptPath != rec.Metadata.NativeTranscriptPath {
	...
	if updated.Metadata.LatestUserPrompt != got.Metadata.LatestUserPrompt || updated.Metadata.LatestAssistantUpdate != got.Metadata.LatestAssistantUpdate || updated.Metadata.NativeTranscriptPath != got.Metadata.NativeTranscriptPath {
...
func TestRecordSessionLatestUserPromptIsNarrowAndMonotonic(t *testing.T) {
	...
	if current.Metadata.LatestUserPrompt != "continue the target work" || current.Harness != domain.HarnessCodex || current.Metadata.RuntimeLaunchID != "target-generation" || current.Metadata.LatestAssistantUpdate != "target already owns this row" {
