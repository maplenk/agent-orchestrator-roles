...
// StageAttachments writes images into a session's worktree and returns their
...
// text, and an image reaches the agent by existing in the worktree the agent can
